...
export const getInvoiceById = createAction('[Invoice] Get Invoice By ID', props<{ id: any }>());
...
export const saveInvoice = createAction('[Invoice] Save Invoice', props<{ invoice: any }>());
...
export const updateInvoice = createAction('[Invoice] Update Invoice', props<{ invoice: any }>());
...
export const deleteInvoice = createAction('[Invoice] Delete Invoice', props<{ id: any }>());
